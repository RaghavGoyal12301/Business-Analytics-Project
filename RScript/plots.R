...
generatePlots <- function(output) {
  ...
  output$variable_importance1 <- renderPlot({ variable_importance()() })
  output$variable_importance2 <- renderPlot({ variable_importance()() })
  # ----------------------------------------------------
  ...
  output$rf_model42_plot1 <- renderPlot({ rf_model42_plot()() })
  output$rf_model42_plot2 <- renderPlot({ rf_model42_plot()() })
  # ----------------------------------------------------
